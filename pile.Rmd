...
d <- d[complete.cases(d[, c("everpile", "OAD", "severity2mid", "pacs_bin2m", "age911", "edu", "empl", "race_binary", "Sex","ntrad", "BMI")]), ]
...
d$everpile <- as.numeric(as.character(d$everpile))
...
formula_m0 <- pacs_bin2m ~ everpile + age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std
# Mediator 1 model: OAD
formula_m1 <- pacs_bin2m ~ everpile + age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std + OAD

# Mediator 2 model: severity2mid
formula_m2 <- pacs_bin2m ~ everpile + age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std + OAD + severity2mid
# Propensity score model for the exposure
formula_ps <- everpile ~ age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std
...
paths_glm <- paths(a = "everpile", y = "pacs_bin2m", m = mediators,
...
mediators <- list("OAD")
# Define formulas for each GLM
formula_m0 <- severity2mid ~ everpile + age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std
# Mediator 1 model: OAD
formula_m1 <- severity2mid ~ everpile + age911_std + edu_1 + edu_2 + edu_3 + edu_99 + empl_1 + empl_99 + race_binary + ntrad + depression_1 + depression_99 + illness_1 + illness_99 + BMI_std + OAD
...
# Fit the propensity score model
glm_ps <- glm(formula_ps, family = binomial("logit"), data = d)
paths_glm <- paths(a = "everpile", y = "severity2mid", m = mediators,
                   glm_ymodels, ps_model = glm_ps, data = d, nboot = 1000)
